    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'login_plugin_db'),
        ...
        'hrezone' => [
            ...
            'database' => env('DB_DATABASE3', 'hr_tool_ezone'),
        ...
        'phoenix50' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST4', '172.20.17.50'),
            'port' => env('DB_PORT4', '3306'),
            'database' => env('DB_DATABASE4', 'phoenix_tt_db'),
            'username' => env('DB_USERNAME4', 'phoenix'),
            'password' => env('DB_PASSWORD4', 'noctoolisdead1234!@#$'),
        ...
        'hr50' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST5', '172.20.17.50'),
            'port' => env('DB_PORT5', '3306'),
            'database' => env('DB_DATABASE5', 'hr_tool_db'),
